...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
        ...
        $data['liveprice_installed'] = \liveopencart\ext\liveprice::getInstance($this->registry)->installed();
        ...
        if ( $this->model_extension_module_parent_child_options->installed() ) {
            $this->document->addStyle($this->model_extension_module_parent_child_options->getProductEditPageStylePath());
