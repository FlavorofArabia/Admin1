...
class ControllerLocalisationCountry extends Controller {
	...
	protected function getForm() {
		...
		} elseif (!empty($country_info) && is_file(DIR_IMAGE . $country_info['image'])) {
			$data['thumb'] = $this->model_tool_image->resize($country_info['image'], 100, 100);
		} else {
