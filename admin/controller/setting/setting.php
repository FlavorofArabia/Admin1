...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['config_newsletter'])) {
            $data['config_newsletter'] = $this->request->post['config_newsletter'];
        } else {
            $data['config_newsletter'] = $this->config->get('config_newsletter');
        }

        if (isset($this->request->post['config_top_header_page'])) {
            $data['config_top_header_page'] = $this->request->post['config_top_header_page'];
        } else {
            $data['config_top_header_page'] = $this->config->get('config_top_header_page');
        }


        if (isset($this->request->post['config_latest_product'])) {
            $data['config_latest_product'] = $this->request->post['config_latest_product'];
        } else {
            $data['config_latest_product'] = $this->config->get('config_latest_product');
        }


        if (isset($this->request->post['config_offer_discount'])) {
            $data['config_offer_discount'] = $this->request->post['config_offer_discount'];
        } else {
            $data['config_offer_discount'] = $this->config->get('config_offer_discount');
        }
