...
//		$this->db->query("INSERT INTO " . DB_PREFIX . "banner SET `key` = '" . $this->db->escape($data['key']) . "' , name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "'");
//
...
//		$this->db->query("UPDATE " . DB_PREFIX . "banner SET `key` = '" . $this->db->escape($data['key']) . "' , name = '" . $this->db->escape($data['name']) . "', status = '" . (int)$data['status'] . "' WHERE banner_id = '" . (int)$banner_id . "'");
